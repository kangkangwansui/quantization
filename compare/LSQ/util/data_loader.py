...
def load_data(cfg):
    ...
    tv_normalize = tv.transforms.Normalize(mean=[0.491, 0.482, 0.447],
    ...
    train_loader = t.utils.data.DataLoader(
        train_set, cfg.batch_size, shuffle=True, num_workers=cfg.workers)
    val_loader = t.utils.data.DataLoader(
        val_set, cfg.batch_size, num_workers=cfg.workers)
    test_loader = t.utils.data.DataLoader(
        test_set, cfg.batch_size, num_workers=cfg.workers)
