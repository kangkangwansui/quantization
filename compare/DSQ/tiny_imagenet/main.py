...
from utils import *
from data_loader import load_tinyimagenet
...
def main(args):
    ...
    dataset_train ,dataset_val , num_classes = load_tinyimagenet(args)
    ...
    if args.evaluate:
        ...
        val_prec1,val_prec5,val_loss = eval_training(model, args, dataset_val, criterion,1)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        losses_train = train(epoch, model, args, dataset_train, optimizer,criterion,warmup_scheduler)

        # evaluate on test set
        val_prec1,val_prec5,val_loss = eval_training(model, args, dataset_val, criterion,epoch)
