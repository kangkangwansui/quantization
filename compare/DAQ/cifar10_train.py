...
def train(config, model, dataloaders, criterion,
    ...
    val_top1 = []
    val_top5 = []
    column_names = ["epoch", "val_top1", "val_top5"]
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        if best_accuracy < top1:
            best_accuracy = top1
        print("best_accuracy is :..................",best_accuracy)
    val_top1.append(best_accuracy)

    write_lists_to_csv(csv_dir,[epoch1,val_top1,val_top5],column_names)
