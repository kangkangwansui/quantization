...
class QuantConv2d(nn.Conv2d):
    ...
    def show_params(self):
        ...
        print('量化方法是: apot, 量化bit为: {:2f}'.format(self.bit))
...
def Quantconv3x3(in_planes, out_planes, stride=1,padding = 1):
    ...
    return QuantConv2d(in_planes, out_planes, kernel_size=3, stride=stride, padding=padding, bias=False)

def Quantconv1x1(in_planes, out_planes, stride=1):
    " 3x3 quantized convolution with padding "
    return QuantConv2d(in_planes, out_planes, kernel_size=1, stride=stride, bias=False)

def Quantconv(in_planes, out_planes, kernel_size=3,stride=1,padding = 1,groups = 1):
    " 3x3 quantized convolution with padding "
    return QuantConv2d(in_planes, out_planes, kernel_size=kernel_size, stride=stride, padding=padding, bias=False,groups=groups)
