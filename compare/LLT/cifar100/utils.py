...
def get_network(args):
    ...
    if args.net == 'resnet18':
        ...
        from resnet_quant import resnet20
        net = resnet20(args.quant)
        print("使用{}模型训练，量化bit为{}".format(args.net,args.bit))
    elif args.net == 'resnet32':
        from resnet_quant import resnet32
        net = resnet32(args.quant)
        print("使用{}模型训练，量化bit为{}".format(args.net,args.bit))
    elif args.net == 'resnet34':
        from resnet_quant import resnet34
        ...
        from resnet_quant import resnet101
        net = resnet101(args.quant)
        print("使用{}模型训练，量化bit为{}".format(args.net, args.bit))
    elif args.net == 'resnet152':
        from resnet_quant import resnet152
