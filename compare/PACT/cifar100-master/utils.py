...
def get_network(args):
    ...
    if args.net == 'resnet18':
        from models.resnet_quant import resnet18
        ...
        from models.resnet_quant import resnet32
        net = resnet32(args.quant)
        print("使用{}模型训练，量化bit为{}".format(args.net,args.bit))
    elif args.net == 'resnet34':
        from models.resnet_quant import resnet34
        net = resnet34(args.quant)
        print("使用{}模型训练，量化bit为{}".format(args.net,args.bit))
    elif args.net == 'resnet50':
        from models.resnet_quant import resnet50
        net = resnet50(args.quant)
        print("使用{}模型训练，量化bit为{}".format(args.net, args.bit))
    elif args.net == 'resnet101':
        from models.resnet_quant import resnet101
        net = resnet101(args.quant)
        print("使用{}模型训练，量化bit为{}".format(args.net, args.bit))
    elif args.net == 'resnet152':
        from models.resnet_quant import resnet152
