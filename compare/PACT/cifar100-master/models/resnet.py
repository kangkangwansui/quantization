...
class ResNet_cifar100(nn.Module):
    ...
    def forward(self, x):
        ...
        return output
def resnet20():
    model = ResNet_cifar100(BasicBlock, [3, 3, 3])
    return model


def resnet32():
    model = ResNet_cifar100(BasicBlock, [5, 5, 5])
    return model


def resnet44():
    model = ResNet_cifar100(BasicBlock, [7, 7, 7])
    return model


def resnet56():
    model = ResNet_cifar100(BasicBlock, [9, 9, 9])
    return model
def resnet18():
