...
parser.add_argument('--seed', '-se', type=int, default=4, help='bitwidth of weights')
...
def train_model(trainloader, testloader, net, device, csv_file):
    ...
    lr_decay_milestones = [100, 150,225,275]
...
def main(args):
    ...
    if args.test:
        ...
        nan = train_model(trainloader, testloader, net, device, csv_file)
