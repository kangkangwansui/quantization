...
class ResNet_cifar10(nn.Module):
    def __init__(self, block, layers, num_classes=10, w_bit=32, a_bit=32):
...
def resnet20(pretrained_path, num_classes):
    resnet = ResNet_cifar10(PreActBasicBlock, [3, 3, 3], num_classes=num_classes, w_bit=32,a_bit=32)
...
def resnet32(pretrained_path, num_classes):
    resnet = ResNet_cifar10(PreActBasicBlock, [5, 5, 5], num_classes=num_classes, w_bit=32,a_bit=32)
...
def resnet18(pretrained_path, num_classes):
    resnet = ResNet_cifar10(PreActBasicBlock, [2, 2, 2, 2], num_classes=num_classes, w_bit=32,a_bit=32)
